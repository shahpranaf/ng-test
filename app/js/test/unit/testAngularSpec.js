describe('Testing Angular Js', function () {
    ...
    describe('Check the title', function () {
        ...
        it('Should remove destination from the destinations list', function() {          
            ...
            expect(scope.destinations.length).toBe(1);
            expect(scope.destinations[0].city).toBeDefined('Pune');
            expect(scope.destinations[0].state).toBeDefined('Maharashtra');
    ...
    describe('Testing Angular JS Filter', function(){
        ...
        it('Filtering the warmest city using warmDestinations Filter', inject(function($filter){
            ...
            var warmestDestinations = warmest(destinations, 30);
    ...
    describe('Testing Angular js directive', function(){
        ...
        beforeEach( function(){
            module(function($provide){
                var MockedcelciusToKelvinService = {
                    celciusToKelvin : function(temp) {
                        return (temp+273.15);
                    }
                }

                $provide.value('celciusToKelvin', MockedcelciusToKelvinService);
        ...
        it('should update weather for specific destination', function() {
            spyOn(celciusToKelvin, 'celciusToKelvin').and.callFake(function(temp){
                return temp + 273.15;
            });
            scope.destination = {
                city: 'Rajkot',
